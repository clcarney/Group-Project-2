...
hist(loansDefualted$delinquencies_over90_days, main = "Default vs Delinquency", xlab = "Number of Days", ylab = "Number of Defaults") #No significant difference among 30,60,90 days
...
hist(loansDefualted$total_inquiries, main = "Default vs Inquiry", xlab = "Number of Inquiries Checked", ylab = "Number of Defaults") #People with fewer credit checks make a larger proportion of people who default

hist(loansDefualted$month, main = "Default vs Starting Month", xlab = "Starting Month", ylab = "Number of Defaults")
axis(side = 1, at = seq(1, 12, by = 1), labels = c("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Oct", "Nov", "Dec"))
