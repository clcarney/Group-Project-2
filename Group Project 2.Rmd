...
library(VGAM)
set.seed(123)
loans_random <- loans[sample(nrow(loans)), ]
loans_train <- loans[1:23310, ]
loans_test <- loans[23311:33300, ]

predict <- predict(loans.m2, newdata = loans_test, type = "response")
