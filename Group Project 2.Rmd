...
Default_neuralnetwork <- train(default1~ ., data = loans2_train, method='nnet')

model_results <- predict(Default_neuralnetwork, loans2_test)

predicted_yes <- ifelse(model_results > 0.04981225, 1, 0)
